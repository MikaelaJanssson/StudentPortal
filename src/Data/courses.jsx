...
export const courses = [
  {
    ...
    description: "Grundkurs i HTML, CSS, JavaScript",
    details:
  ...
  {
    id: "2",
    name: "React för nybörjare",
    description: "Lär dig bygga SPA med React",
    details:
  ...
  {
    id: "3",
    name: "Grundkurs i Javascript",
    description: "Skapa interaktiva webbapplikationer",
    details:
